...
const SIDEBAR_ITEMS = [
  ...
  { label: 'Quản lý thời gian', icon: 'bi-calendar-event', path: '/time-management' },
];
        ...
        <div className="d-flex min-vh-100">
          ...
          <nav
            ...
            style={{
              ...
              color: '#fff',
              minHeight: '100vh',
              boxShadow: '2px 0 16px rgba(51,138,255,0.08)',
              transition: 'width 0.2s cubic-bezier(.4,0,.2,1)',
            }}
          >
            <div className="p-3">
              <h4
                className="sidebar-title text-center fw-bold mb-4"
                ...
                {SIDEBAR_ITEMS.map((item) => {
                  ...
                  return (
                    <li key={item.path} className="nav-item">
                      <Link
                        href={item.path}
                        className={`nav-link d-flex align-items-center gap-2 sidebar-animate${
                          isActive ? ' active' : ''
                        }`}
                        style={{
